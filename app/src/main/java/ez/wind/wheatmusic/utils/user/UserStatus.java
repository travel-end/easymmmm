package ez.wind.wheatmusic.utils.user;
...
public class UserStatus {
    ...
    public static void saveUserInfo(User userInfo) {
        SharedPreferences sp = WheatApp.Companion.getInstance().getApplicationContext().getSharedPreferences("user", Context.MODE_PRIVATE);
