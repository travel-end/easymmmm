...
//        val cachePath = FileUtil.getMusicCacheDir() + music.artist + " - " + music.title + "(" + music.quality + ")"
//        val downloadPath = FileUtil.getMusicDir() + music.artist + " - " + music.title + ".mp3"
//        if (FileUtil.exists(cachePath)) {
//            FileUtil.delFile(cachePath)
//        }
//        if (FileUtil.exists(downloadPath)) {
//            FileUtil.delFile(downloadPath)
//        }
//        if (FileUtil.exists(music.uri)) {
//            FileUtil.delFile(music.uri)
//        }
...
//    }
    ...
    fun getAllPlaylist(): MutableList<Playlist> {
        return LitePal.where("type = ?", Constants.PLAY_LIST_LOCAL).find(Playlist::class.java)
    }
