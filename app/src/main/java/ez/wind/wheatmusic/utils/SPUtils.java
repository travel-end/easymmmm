...
public class SPUtils {
    ...
    public static boolean getWifiMode() {
        return getAnyByKey(WheatApp.Companion.getInstance().getApplicationContext().getString(R.string.setting_key_mobile_wifi), false);
    }

    public static void saveWifiMode(boolean enable) {
        putAnyCommit(WheatApp.Companion.getInstance().getApplicationContext().getString(R.string.setting_key_mobile_wifi), enable);
    }
    ...
    private static SharedPreferences getPreferences() {
        return PreferenceManager.getDefaultSharedPreferences(WheatApp.Companion.getInstance().getApplicationContext());
    }
}
