package ez.wind.wheatmusic.utils.player.playqueue
...
//        playingModeId = SPUtils.getPlayMode()
    ...
    fun getPlayMode(): String {
        return WheatApp.getInstance().getString(playingMode[playingModeId]);
    }
    ...
    private fun printOrderList(cur: Int) {
        LogUtil.e("PlayQueueManager", "$orderList --- $cur")
    }
}
