...
//    const val ACTION_SERVICE = "ez.wind.wheat_music.service"//广播标志
//    const val ACTION_NEXT = "ez.wind.wheat_music.notify.next" // 下一首广播标志
//    const val ACTION_PREV = "ez.wind.wheat_music.notify.prev" // 上一首广播标志
//    const val ACTION_PLAY_PAUSE = "ez.wind.wheat_music.notify.play_state" // 播放暂停广播
//    const val ACTION_CLOSE = "ez.wind.wheat_music.notify.close" // 播放暂停广播
//    const val ACTION_IS_WIDGET = "ACTION_IS_WIDGET" // 播放暂停广播
//    const val ACTION_LYRIC = "ez.wind.wheat_music.notify.lyric" // 播放暂停广播
//    const val PLAY_STATE_CHANGED = "ez.wind.wheat_music.play_state" // 播放暂停广播
//    const val PLAY_STATE_LOADING_CHANGED = "ez.wind.wheat_music.play_state_loading" // 播放loading
//    const val SHUTDOWN = "ez.wind.wheat_music.shutdown"
//    const val PLAY_QUEUE_CLEAR = "ez.wind.wheat_music.play_queue_clear" //清空播放队列
//    const val PLAY_QUEUE_CHANGE = "ez.wind.wheat_music.play_queue_change" //播放队列改变
//    const val META_CHANGED = "ez.wind.wheat_music.metachanged" //状态改变(歌曲替换)
