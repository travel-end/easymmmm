package ez.wind.wheatmusic.net.api.music

import com.cyl.musicapi.baidu.BaiduApiService
import ez.wind.wheatmusic.constants.Constants
import ez.wind.wheatmusic.model.*
import ez.wind.wheatmusic.net.ApiManager
import ez.wind.wheatmusic.utils.FileUtils
import ez.wind.wheatmusic.utils.LogUtil
import ez.wind.wheatmusic.utils.MusicUtils
import ez.wind.wheatmusic.utils.MusicUtils.PIC_SIZE_BIG
import ez.wind.wheatmusic.utils.MusicUtils.PIC_SIZE_NORMAL
import ez.wind.wheatmusic.utils.MusicUtils.PIC_SIZE_SMALL
...
object BaiduApiServiceImpl {
    ...
    private val apiService by lazy { ApiManager.getInstance()
        .create(BaiduApiService::class.java, Constants.BASE_URL_BAIDU_MUSIC) }
