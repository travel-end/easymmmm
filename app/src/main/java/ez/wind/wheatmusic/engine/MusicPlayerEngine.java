package ez.wind.wheatmusic.engine;
...
public class MusicPlayerEngine implements MediaPlayer.OnErrorListener,
    ...
    private boolean setDataSourceImpl(final MediaPlayer player, final String path) {
        ...
        try {
            ...
            mIsPrepared = false;
            player.reset();
            boolean cacheSetting = PreferenceManager.getDefaultSharedPreferences(WheatApp.Companion.getInstance()).getBoolean("key_cache_mode", true);
            ...
            if (path.startsWith("content://") || path.startsWith("/storage")) {
                ...
                //缓存开启，读取缓存
                HttpProxyCacheServer proxy =WheatApp.Companion.getProxy();
